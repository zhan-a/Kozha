...
Captured by `scripts/a11y/run.mjs` on 2026-04-25 02:30:51 UTC.
...
| contribute-empty | Contribute — empty state, language picker | 0 | 0 | 0 | 1 | 0 | 28 |
| contribute-after-language | Contribute — language selected, empty authoring area | 0 | 0 | 0 | 1 | 0 | 0 |
| contribute-mid-session | Contribute — mid-session (chat + preview + notation + submit visible) | 0 | 0 | 0 | 1 | 0 | 0 |
...
- **warning** `WCAG2AA.Principle2.Guideline2_5.2_5_3.F96` — Accessible name for this element does not contain the visible label text. Check that for user interface components with labels that include text or images of text, the name contains the text that is presented visually.
  - `#main-content > section:nth-child(1) > div:nth-child(1) > a`
- **warning** `WCAG2AA.Principle1.Guideline1_4.1_4_3.G18.BgImage` — This element's text is placed on a background image. Ensure the contrast ratio between the text and all covered parts of the image are at least 4.5:1.
  - `#main-content > section:nth-child(1) > div:nth-child(1) > a > span:nth-child(2) > strong`
- …and 21 more (see raw)

## Translator /app — fresh load

- URL: `http://127.0.0.1:62468/app.html`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
...
- URL: `http://127.0.0.1:62468/progress.html`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
...
- URL: `http://127.0.0.1:62468/credits.html`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
...
- URL: `http://127.0.0.1:62468/404.html`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
- pa11y: 0 error, 7 warning
...
- URL: `http://127.0.0.1:62468/contribute.html`
- axe: 0 critical, 0 serious, 0 moderate, 1 minor
- pa11y: 0 error, 28 warning

### axe violations

- **minor** `aria-allowed-role` — ARIA role should be appropriate for the element ([docs](https://dequeuniversity.com/rules/axe/4.11/aria-allowed-role?application=axe-puppeteer))
  - `#c2-panel-1`
...
- URL: `http://127.0.0.1:62468/governance.html`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
- pa11y: 0 error, 7 warning
...
- URL: `http://127.0.0.1:62468/contribute/status/sim-draft`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
...
- URL: `http://127.0.0.1:62468/contribute/status/sim-pending_review`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
- pa11y: 0 error, 8 warning
...
- URL: `http://127.0.0.1:62468/contribute/status/sim-under_review`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
- pa11y: 0 error, 8 warning
...
- URL: `http://127.0.0.1:62468/contribute/status/sim-validated`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
- pa11y: 0 error, 8 warning
...
- URL: `http://127.0.0.1:62468/contribute/status/sim-rejected`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
- pa11y: 0 error, 8 warning
...
- URL: `http://127.0.0.1:62468/contribute/status/sim-quarantined`
- axe: 0 critical, 0 serious, 0 moderate, 0 minor
- pa11y: 0 error, 8 warning
